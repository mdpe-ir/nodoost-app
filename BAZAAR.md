...
1. برنامه‌ای با پکیج `ir.nodoost.app` بساز.
...
```
BAZAAR_PACKAGE_NAME=ir.nodoost.app
BAZAAR_CLIENT_ID=...
...
مسدودکننده با دکمه‌ی «به‌روزرسانی از بازار» (دیپ‌لینکِ `bazaar://details?id=ir.nodoost.app`)
